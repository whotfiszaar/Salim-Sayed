  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
                ...
                <li key={link.label}>
                  ...
                  >
                    <span className="flex items-center gap-4">
                      ...
                      <span>
                        <span className="block text-[11px] font-semibold tracking-[0.18em] text-cream/70 uppercase">
                          {link.label}
                        </span>
                    ...
                    <ArrowUpRight
                      size={18}
                      className="text-cream/70 transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-cream"
                      aria-hidden="true"
                    />
                  </a>
                </li>
        ...
        {/* Footer bar */}
        <div className="flex flex-col items-center justify-between gap-3 border-t border-cream/15 pt-6 text-[12px] text-cream/70 sm:flex-row">
          <p>
